        ...
        <div class="zaglavlje">
            ...
            <ul class="pozadina">
                <li style="display: inline-block;line-height: 50px; margin-top: 5px; margin-right: 50px">
                    <button id="btnPrikaz" style="text-transform: uppercase;">Prikazi sve projekcije</button>
                </li>

                <li style="display: inline-block;line-height: 50px; margin-top: 5px ;margin-right: 50px">
                    <button id="-zakazivanje" type="button" data-toggle="modal" data-target="#myModal" style="text-transform: uppercase;">Zakazi novu projekciju</button>
                </li>

                <li style="display: inline-block;line-height: 50px; margin-top: 5px ;margin-right: 50px">
                    <div class="col-md-4a">
                        <button id="btn-pretraga" style="text-transform: uppercase;">Pretrazi projekcije</button>
            ...
            <div class="row">
                <ul class="pozadina" style="margin-left:12%; margin-top: 50px; ">
                    <li style="display: inline-block;  line-height: 50px; ">
                        <div class="col-md-1">
                            <button id="dugme-izmeni" style="background-color: bisque; width: 400px; border-radius: 5px; font-size: 25px;" data-toggle="modal" data-target="#izmeniModal">Izmeni zakazanu projekciju</button>
